...
! ============================================================================
  ...
  real, intent(in) :: dt
  real, intent(inout), dimension(:) :: bucket_depth, depth_change_lh_1d
  ...
  ! initialize surface air humidity depending on whether surface is dry or wet
  ! (bucket empty or not)
...
subroutine surface_flux_2d (                                           &
  ...
  real, intent(inout), dimension(:,:) :: q_surf
  real, intent(in) :: dt
  real, intent(inout), dimension(:,:) :: bucket_depth, depth_change_lh
