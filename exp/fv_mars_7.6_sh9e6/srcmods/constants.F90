...
real, public, save    :: sigma_sca = 1.4098e-6 !scattering cross section

real, public, parameter :: r_cld  = 10e-6   !cloud droplet radius [m]
real, public, parameter :: GRAV   = 3.71 !3.72 !9.80 need to change later
...
real, public, parameter :: RDGAS  = Rstar / (mu_CO2*1e-3)
real, public, parameter :: CP_AIR = 820.
